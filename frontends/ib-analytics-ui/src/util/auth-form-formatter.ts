...
import { Flows, UiNodeInputAttributes } from "@ory/kratos-client";
import { getFormFieldPosition } from ".";
...
export const formatFormFields = (flow: Flows, method: string) => {
  ...
  // flow.ui.nodes[0].attributes.sort(
  //   (first: UiNodeInputAttributes, second: UiNodeInputAttributes) =>
