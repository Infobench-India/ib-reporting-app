...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom.js', import.meta.url).href),import:true},'react-redux':{get:()=>()=>__federation_import(new URL('__federation_shared_react-redux.js', import.meta.url).href),import:true},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom.js', import.meta.url).href),import:true},'recharts':{get:()=>()=>__federation_import(new URL('__federation_shared_recharts.js', import.meta.url).href),import:true}};
