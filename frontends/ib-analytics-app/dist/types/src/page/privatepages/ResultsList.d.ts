...
declare function ResultsList({ data, getAllProp, updateProp, removeProp, searchProp, }: Props): import("react/jsx-runtime").JSX.Element;
declare const _default: import("react-redux").ConnectedComponent<typeof ResultsList, {
