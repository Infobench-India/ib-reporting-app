...
declare const StageconfigService: {
    ...
    updateStageStatus: import("@reduxjs/toolkit").AsyncThunk<any, {
        id: string;
        status: boolean;
    }, {
        state?: unknown;
    ...
    updateStatus: import("@reduxjs/toolkit").AsyncThunk<any, {
        id: string;
        data: any;
    }, {
        state?: unknown;
    ...
    findByStageconfig: import("@reduxjs/toolkit").AsyncThunk<any, any, {
        state?: unknown;
        dispatch?: import("redux-thunk").ThunkDispatch<unknown, unknown, import("redux").UnknownAction>;
        extra?: unknown;
        rejectValue?: unknown;
